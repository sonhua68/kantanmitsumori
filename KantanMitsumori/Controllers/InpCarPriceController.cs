...
namespace KantanMitsumori.Controllers
{
    public class InpCarPriceController : BaseController
    {
        ...
        public InpCarPriceController(IEstMainService appService, IConfiguration config, IEstimateService estimateService, ILogger<InpHanbaitenController> logger) : base(config)
        {

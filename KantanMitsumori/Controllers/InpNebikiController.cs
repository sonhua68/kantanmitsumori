...
namespace KantanMitsumori.Controllers
{
    public class InpNebikiController : BaseController
    {
        ...
        public InpNebikiController(IAppService appService, IEstimateService estimateService, IConfiguration config, ILogger<InpNebikiController> logger) : base(config)
        {
